...
`python addUsersToGroups.py https://webadaptor.domain.com:7443/arcgis admin password Operations user1,user2,user3`
...
`python changeOwnership.py https://webadaptor.domain.com:7443/arcgis admin password johndoe janedoe`
...
`python copyContent.py https://webadaptor.domainA.com:7443/arcgis admin password owner:johndoe https://webadaptor.domainB.com:7443/arcgis admin password janedoe /`
...
`python updateWebmapServices.py https://webadaptor.domain.com:7443/arcgis admin password "type: Web Map" http://server.domainA.com http://server.domainB.com`